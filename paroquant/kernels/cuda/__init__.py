...
if torch.version.hip is not None:
    # PyTorch ROCm still uses CUDA device/dispatch names, but the upstream CUDA
    # extension includes CUDA-only headers. Keep existing import paths working by
    # registering a HIP implementation under the same torch.ops.rotation op.
    from paroquant.kernels.rocm import RotateTensorFunc, scaled_pairwise_rotation
